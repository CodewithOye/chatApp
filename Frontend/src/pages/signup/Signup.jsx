        ...
        <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <input type="password" placeholder='Enter your password' className='w-full input input-bordered h-10' value={inputs.password}
                ...
                <div>
                    ...
                    <input type="password" placeholder='Confirm your password' className='w-full input input-bordered h-10' value={inputs.confirmPassword}
